...
| Sound | Compact Settings picker: off, ICQ, four branded-style presets backed by licensed open audio, five Ocean presets, and user-imported files. Users may remove only OmaQ-managed custom copies; bundled sounds remain immutable. |
