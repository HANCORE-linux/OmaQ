...
| Sound | Compact Settings picker: off, UHOH, PING, MSN, Aurora, Glow, Click, Knock, and user-imported files. Users may remove only OmaQ-managed custom copies; bundled sounds remain immutable. Removed preset selections fall back to UHOH. |
