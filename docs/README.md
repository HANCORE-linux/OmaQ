...
| [Current status](CURRENT.md) | Where the build is |
| [Execution plan](PLAN.md) | Architecture law, phases, verify gates |
| [Stage notes](stages/README.md) | One file per finished phase |
| [Third party](../THIRD_PARTY.md) | toxcore, libsignal-protocol-c, OpenSSL |

German product contract (outside this repo): `~/Projects/Prompt-Uebergabe/OmaQ.md`
