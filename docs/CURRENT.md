...
- **Branch:** `main`
- **Manifest version:** `0.8.0` in the current worktree; live remains `0.7.0`
...
- **Source commit:** local `main` and `origin/main` are both `4f0ba359`; Protocol-10 identity/update/reinvite hardening is an uncommitted worktree and has not been deployed
- **Live machine:** Protocol 9 at `4f0ba359`; deployed helper SHA-256 `5349d1d4425e8323b70a9b0e788af876c3280fc36f03d2157e991385ab799879`
