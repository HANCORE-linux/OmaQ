...
COMMAND = b'{"op":"status"}\n'
EVENT = b'{"event":"snapshot","protocol":13,"unread":0,"conversations":[],"call":null}\n'
STATUS_NONCE_COMMAND = b'{"op":"status","id":"fresh-status-1"}\n'
STATUS_NONCE_EVENT = b'{"event":"snapshot","protocol":13,"unread":0,"conversations":[],"call":null,"request":"fresh-status-1"}\n'
