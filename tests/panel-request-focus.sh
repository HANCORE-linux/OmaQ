...
mkdir -p "$tmp/omaq"
for path in Panel.qml Service.qml Model.js Emoji.js CallTone.qml ChatSurface.qml \
  SurfaceCoordinator.qml qmldir assets pages sounds themes scripts helper manifest.json; do
